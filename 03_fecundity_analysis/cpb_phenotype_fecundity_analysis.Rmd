...
<b>F0</b>: <br>
Days: t = 0.943118; p = 0.3461; d.f. = 437 <br>
Background: t = 0.815506; p = 0.4268; d.f. = 16 <br>
Days x Background : t = -1.531633; p = 0.1263; d.f. = 437 <br>

<b>F1</b>: <br>
Days: t = -1.847735; p = 0.0656; d.f. = 313 <br>
Background: t = -0.319095; p = 0.7541; d.f. = 15 <br>
Days x Background : t = 0.411236; p = 0.6812; d.f. = 313 <br>

<b>F2</b>: <br>
Days: t = -2.198734; p = 0.0285; d.f. = 353 <br>
Background: t = 1.211570; p = 0.2444; d.f. = 15 <br>
Days x Background: t = -0.662149; p = 0.5083; d.f. = 353 <br>

<b>F3</b>: <br>
Days: t = -4.486162; p = 0.0000; d.f. = 323 <br>
Background: t = -0.561831; p = 0.5838; d.f. = 13 <br>
Days x Background: t = 1.119440; p = 0.2638; d.f. = 323 <br>
...
f0_plot <- ggplot(f0, aes(x = days_since_oviposition, y = mean)) +
  geom_line(aes(x = days_since_oviposition, y = mean, color = background), 
            ...
            linewidth = 2, 
            show.legend = T) +
  geom_hline(yintercept = 32.23195, size = 2, linetype = "dashed") +
