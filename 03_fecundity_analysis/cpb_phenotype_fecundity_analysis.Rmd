...
#### 1b: Plot daily and total fecundity for each generation; run the Rmd chunk below.

##### Plot daily and total fecundity: 1) `figures/daily_fecundity_means.pdf` and 2) `figures/total_fecundity_means.pdf`
```{r}
# load fecundity data
load("data/fecundity.Rda")
