...
<b>Summary results</b>:
LC<sub>25</sub> (initial estimate) = 12.21458 ppm

#### 3b: Plot fitted probit regression for lc data; run the Rmd chunk below.

##### Plot probit regression: `figures/lc.pdf`
```{r}
# Load in raw LC data
load("data/lc.Rda")

# Plot probit curve of survival at all dosages
jpeg("figures/lc.jpeg", width = 5000, height = 4000, res = 800)

ggplot(lc, aes(x = dosage, y = survival_status)) + 
  ...
  theme_set(theme_cowplot(12)) +
  geom_hline(yintercept = 0.75, color = "blue", linetype = "longdash", size = 1) +
  geom_vline(xintercept = 12.21458, color = "blue", linetype = "longdash", size = 1) +
