...
mass <- ggplot(development, aes(x = pupa_mass, y = adult_mass)) + 
  ...
  scale_x_continuous(breaks = seq(from = 0, to = 200, by = 40), 
                     limits = c(0,200), 
                     expand = c(0,0)) + 
  scale_y_continuous(breaks = seq(from = 0, to = 200, by = 40), 
                     limits = c(0,200), 
                     expand = c(0,0)) +
...
These figures were used for prelminary and exploratory analysis only and are not presented in the final ms.
