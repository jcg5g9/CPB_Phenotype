...
mobility <- performance %>%
  ...
  mutate(mobility = as.numeric(ifelse(total_distance != 0, "1", "0"))) %>%
...
# get only herbivory data from performance data and add binary value indicating whether there was consumption 
