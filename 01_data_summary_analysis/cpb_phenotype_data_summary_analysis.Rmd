...
# calculate average eggs per day for each treatment, lineage, and generation and make new dataframe
average_fecundity <- fecundity %>%
  group_by(adult_generation, lineage, treatment) %>%
...
<b><i>N</i><sub>F0_E_E</sub> = 72 </b><br>
