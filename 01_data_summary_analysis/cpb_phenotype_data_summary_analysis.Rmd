...
In this step, we read in and clean the full fecundity dataset (`../raw_data/cpb_tei_fecundity_data.xlsx`) and parental mass dataset (`../raw_data/cpb_tei_mass_data.xlsx`) for mated pair beetles and merge the datasets. We omit all fecundity data from the founder generation ('FNDR') from downstream statistical analyses. <br>
