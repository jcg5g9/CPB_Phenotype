...
# generate list of levels wihtin group factor
...
for(i in levels) {
  ...
  fit_unif <- fitdist(subset$total_distance, "unif") # fit uniform distribution to total distance data within subset
  fit_norm <- fitdist(subset$total_distance, "norm") # fit normal distribution to total distance data within subset
  fit_nbin <- fitdist(subset$total_distance, "nbinom") # fit negative binomial distribution to total distance data within subset
...
# combine all stats into a single table
