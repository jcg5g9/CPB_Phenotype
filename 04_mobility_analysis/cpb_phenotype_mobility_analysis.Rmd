...
#
distance <- distance %>%
  mutate(group = ifelse(background == "C" & treatment == "C", "CN",
                        ifelse(background == "C" & treatment == "E", "CR",
                               ifelse(background == "E" & treatment == "C", "EN",
                                      ifelse(background == "E" & treatment == "E", "ER", "done")))))
...
jpeg("figures/distance_memory_groups.jpeg", width = 10000, height = 8000, res = 700)
