...
ggplot(mobility, aes(x = total_distance)) +
  ...
  geom_line(aes(x = total_distance, y = dgamma(mobility$total_distance, gamm$estimate["shape"], gamm$estimate["rate"])), color = "black", linetype = "longdash", linewidth = 1) +
  theme_set(theme_cowplot(12)) +
...
# plot f0 data
f0_plot <- ggplot(f0, aes(x = background, y = prop_mobility, group = background, color = background)) +
  geom_errorbar(aes(ymin = prop_mobility - se_mobility, ymax = prop_mobility + se_mobility, color = background), 
                position = position_dodge(width = 0.4), 
                width = 0.2, 
                linewidth = 2, 
                show.legend = F) +
   geom_point(aes(x = background, y = prop_mobility, group = background, fill = background), 
              position = position_dodge(width = 0.4), 
              size = 7, 
              pch = 22, 
              stroke = 2, 
...
# plot f1 data
f1_plot <- ggplot(f1, aes(x = treatment, y = prop_mobility, group = background, color = background)) +
  ...
  geom_errorbar(aes(ymin = prop_mobility - se_mobility, ymax = prop_mobility + se_mobility, color = background), 
                ...
                linewidth = 2, 
                show.legend = F) +
   geom_point(aes(x = treatment, y = prop_mobility, group = background, fill = background), 
              position = position_dodge(width = 0.4), 
              size = 7, 
              pch = 22, 
              stroke = 2, 
...
# plot f2 data
f2_plot <- ggplot(f2, aes(x = treatment, y = prop_mobility, group = background, color = background)) +
  geom_line(aes(color = background), 
            position = position_dodge(width = 0.4), 
            linewidth = 2, 
            show.legend = F) + 
...
# plot f3 data
f3_plot <- ggplot(f3, aes(x = treatment, y = prop_mobility, group = background, color = background)) +
  geom_line(aes(color = background), 
            position = position_dodge(width = 0.4), 
            linewidth = 2, 
            show.legend = F) + 
