...
#### 2a: Test fit of alternative distributions to the empirical data.
...
ggplot(herbivory, aes(x = leaf_area_consumed)) +
  ...
  geom_line(aes(x = leaf_area_consumed, y = dgamma(herbivory$leaf_area_consumed, gamm$estimate["shape"], gamm$estimate["rate"])), color = "black", linetype = "longdash", linewidth = 1) +
...
#### 3b: Plot probability of hervivory data; run the Rmd chunk below.

##### Plot probability data: `figures/herbivory_means.jpeg`
```{r}
# load herbivory data
load("data/herbivory.Rda")
