...
|:----------|:-----------------|:-----------------|:----------------- | 
| F0_C_N    | -223.503         | -205.761         | <b>-88.812</b>    | 
| F0_E_N    | -203.925         | -197.072         | <b>-69.398</b>    |
| F1_C_N    | -85.261          | -80.147          | <b>-66.657</b>    | 
| F1_C_R    | -107.474         | -120.673         | <b>-16.505</b>    |
| F1_E_N    | -75.030          | -63.358          | <b>-59.169</b>    |
| F1_E_R    | -128.401         | -121.989         | <b>-17.686</b>    | 
| F2_C_N    | -55.271          | -48.551          | <b>-46.886</b>    |
| F2_C_R    | -80.299          | -83.199          | <b>-19.301</b>    | 
| F2_E_N    | -50.383          | -40.278          | <b>-26.729</b>    | 
| F2_E_R    | -79.023          | -71.588          | <b>-23.297</b>    | 
| F3_C_N    | -40.748          | -33.974          | <b>-17.740</b>    | 
| F3_C_R    | -57.926          | -61.074          | <b>-5.465</b>     |
| F3_E_N    | -74.813          | -73.264          | <b>-20.262</b>    |
| F3_E_R    | -106.766         | -114.668         | <b>-5.106</b>     |
| Global    | -1122.154        | -1159.560        | <b>-487.994</b>   |
...
### STEP 3: Assess phenotypic effects of insecticide stress in total herbivory.

#### 3a: Run two-factor general linear mixed effect interaction models assuming a zero-inflated gamma distribution to test the relative effects of background and treatment of insecticide stress on herbivory; run the Rmd chunk below.
...
#### 3b: Run individual logistic regression models to assess probability of herbivory and estimate marginal means within treatments and backgrounds; run the Rmd chunk below.

##### Run logisitic regression models for herbivory and extract marginal means:
```{r}
# load herbivory data
load("data/herbivory.Rda")
...
### STEP 4: Plot mobility data analyses

#### 4a: Plot probability of hervivory data; run the Rmd chunk below.
...
jpeg("figures/herbivory_probability.jpeg", width = 20000, height = 4000, res = 1000)
...
#### 4b: Plot means of hervivory data; run the Rmd chunk below.
...
f0_plot <- ggplot(f0, aes(x = background, y = mean, group = background, color = background)) +
  ...
  scale_color_manual(values = c("deepskyblue2", "firebrick3")) +
  scale_fill_manual(values = c("deepskyblue2", "firebrick3")) +
  scale_y_continuous(breaks = seq(from = 0, to = 0.15, by = 0.03),
                     limits = c(0,0.15)) +
  theme(axis.text.x = element_text(angle = 0, hjust = 1)) + 
  theme(axis.text = element_text(size = 30, hjust = 0.4)) + 
  theme(axis.title = element_text(size = 30, hjust = 0.5)) + 
...
jpeg("figures/herbivory_means.jpeg", width = 20000, height = 4000, res = 1000)
