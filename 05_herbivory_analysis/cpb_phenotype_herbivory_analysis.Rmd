...
For many of our groups of interest, specific distributions failed to be fitted successfully, likely becasue of insufficient data. The best  
...
herbivory <- herbivory %>%
  filter(leaf_area_consumed != 0)

ggplot(herbivory, aes(leaf_area_consumed)) + geom_histogram()
