...
#### 1a: Run two-factor general mixed effect logistic regression models to test the relative effects of background and treatment of insecticide stress on probability of consuming leaf tissue; run the Rmd chunk below.
