...
fit_unif <- fitdist(f3er$leaf_area_consumed, "unif")
fit_norm <- fitdist(f3er$leaf_area_consumed, "norm")
fit_gamm <- fitdist(f3er$leaf_area_consumed, "gamma")
fit_expo <- fitdist(f3er$leaf_area_consumed, "exp")
fit_beta <- fitdist(f3er$leaf_area_consumed, "beta")
